...
function insert_flat($pdo)
{
  ...
  ( `cost_month`, `date_available`, `location`, `num_of_bedrooms`, `num_of_bathrooms`,
   ...
   `has_car_parking`, `backyard`, `has_playground`, `has_storage`, `about_location`, `user_id`) 
    ...
    // $sql_ins_flat = "INSERT INTO `flat`( `cost_month`, `date_available`, `location`, `num_of_bedrooms`, `num_of_bathrooms`, `rent_condition`, `size`, `furnished`, `has_heating_system`, `has_air_condition`, `has_access_control`, `has_car_parking`, `backyard`, `has_playground`, `has_storage`, `about_location`, `user_id`) VALUES (\'2\',\'2022-8-2\',\'abu-qush\',\'3\',\'2\',\'no\',\'88\',\'1\',\'1\',\'1\',\'1\',\'1\',\'none\',\'1\',\'1\',\'near abu\',\'100000001\');";

    //$sql_ins_flat = "INSERT INTO `flat`( `cost_month`, `date_available`, `location`, `num_of_bedrooms`, `num_of_bathrooms`, `rent_condition`, `size`, `furnished`, `has_heating_system`, `has_air_condition`, `has_access_control`, `has_car_parking`, `backyard`, `has_playground`, `has_storage`, `about_location`, `user_id`) VALUES" . "(\'$_SESSION['cost_month']\',\'2022-8-2\',\'abu-qush\',\'3\',\'2\',\'no\',\'80\',\'1\',\'1\',\'1\',\'1\',\'1\',\'none\',\'1\',\'1\',\'near abu\',\'100000001\');";
...
{
    return '<form enctype="multipart/form-data" method="post"  action ="./offer_flat.php">
             <div>
...
$num_of_marketing_places_form = <<<EDO
            <form method="post" action="./offer_flat.php">
                <fieldset>
                    ...
                    <h2>(Optional) you can add as many near marketing places: <input type="number" min="0" name="num_of_marketing_places" step='1'  placeholder='Number of marketing places'></h2>
...
$num_of_days_time_table_form = <<<EDO
            <form method="post" action="./offer_flat.php">
                <fieldset>
                    ...
                    <h2>(mandatory) Set the number of days: <input type="number" min="1" name="num_of_days_preview" step='1'  placeholder='Number of days' required></h2>
                    <button type ="submit">Next</button>
    ...
    $time_table_form = <<<EDO
            ...
            <div class = 'form_line'>
                ...
                <select name='days[]'>
                    ...
                    Start time: <input type="time" name="time_start[]"> 
                    End time: <input type="time" name="time_end[]">
...
function display_time_table_forms($i)
{
    ...
    echo '<form method="post" action="./offer_flat.php">
            <fieldset>
...
function marketing_places_form()
{
    return '
                ...
                <div class = "form_line">
                    ...
                    <input type="text" name="discreption[]"  placeholder="discreption" >
                </div>
...
function print_success_flat_offer()
{
    ...
    echo "<h3>Your flat has been added successfully, click <a href = '../index.html'>here</a> to go to main page</h3>";
...
<form method="post" action="./offer_flat.php">
    ...
    <div class = 'form_line'>
     ...
     <input type='number' min='1' max='10' step='1' name='num_of_bedrooms' placeholder='bedrooms' />
    </div>

    <div class = 'form_line'>
     <label for='num_of_bathrooms'>Number of bathrooms:</label>
     <input type='number' min='1' max='10' step='1' name='num_of_bathrooms' placeholder='bathrooms' />
    </div>
    ...
    <div class = 'form_line'>
     ...
     <input type='number' min='50' max='200' step='1' name='size' placeholder='Size in squred meter' />
    </div>
    ...
    <main>
        ...
        if (isset($_SESSION)  && isset($_SESSION['logged_in'])   && $_SESSION['logged_in'] == "true") {
            ...
            if ($_SESSION['user_type'] == "owner" || $_SESSION['user_type'] == "manager") {
                ...
                echo "<h3>Customers can not offer flats, click <a href = '../index.html'>here</a> to go to main page</h3>";
